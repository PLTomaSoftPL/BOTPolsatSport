...
namespace GksKatowiceBot.Helpers
{
    public class BaseGETMethod
    {
        ...
        public static IList<Attachment> GetCardsAttachmentsPopularne(ref List<IGrouping<string, string>> hrefList, bool newUser = false)
        {
            List<Attachment> list = new List<Attachment>();
        ...
        public static IList<Attachment> GetCardsAttachmentsNajwazniejsze(ref List<IGrouping<string, string>> hrefList, bool newUser = false)
        {
            List<Attachment> list = new List<Attachment>();
        ...
        public static IList<Attachment> GetCardsAttachmentsNajnowsze(ref List<IGrouping<string, string>> hrefList, bool newUser = false)
        {
            List<Attachment> list = new List<Attachment>();
